...
## Camada complementar SQuaRE (ISO/IEC 25010, 25023 e 25040)

- Requisitos de qualidade: `docs/square-quality-requirements.md`
- Catalogo de metricas: `docs/square-metrics-catalog.md`
- Metodo de avaliacao: `docs/square-evaluation-method.md`
- Matriz SQuaRE: `docs/square-traceability.md`
- Scorecards: `reports/square/scorecard-YYYY-MM-DD.{json,md}`
